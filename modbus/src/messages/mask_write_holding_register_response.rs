...
pub struct MaskWriteHoldingRegisterResponse {
    pub address: u16,
    pub and_mask: u16,
    pub or_mask: u16,
}

impl Encodable for MaskWriteHoldingRegisterResponse {
...
impl Decodable<Self> for MaskWriteHoldingRegisterResponse {
